...
provenance: M · `python3 tools/hlidskjalf.py --write` · 2026-08-11 21:14 UTC · verify: re-run it —
...
**The action, precisely:** Per repo: `git checkout -b promote/<topic> origin/main`, `git cherry-pick <the chosen commits>`, push that branch, PR it into `main`. Choose the cream — a promotion is a selection, not a transfer.
...
### 2. Decide the 1 open PRs riding retired-class branches
...
**The action, precisely:** Merge or deliberately close each: localDNS #30 (Codex IX: the Loki Norn — site the promotion…). Branches involved: claude/loki-norn-promotion-e9e8vf.

**Unblocks:** The 321-ref deletion pass (branch-retirement-manifest §2).
**Source:** O · pr-snapshot.json, 2026-08-11T14:40:00Z
...
| ---- | ----------- | ---------------- | --------------- | ------ | ---- |
| `PRICING-MODELS---ALL-THREE` | +10 | ❌ pre-policy | 0 | `428de717` | oldest unmerged 2026-08-08 |
| `Marketing-Strategy-1` | +10 | ❌ pre-policy | 0 | `c7be6a3a` | oldest unmerged 2026-08-08 |
| `MARKETING` | +10 | ❌ pre-policy | 0 | `b2c18532` | oldest unmerged 2026-08-08 |
| `localDNS` | +47/-6 | ❌ pre-policy | 2 | `ba1ecd3b` | oldest unmerged 2026-08-08 |
| `Home-Sovereign-Full-Field-Guide` | +10 | ❌ pre-policy | 0 | `54fe3fda` | oldest unmerged 2026-08-08 |
| `DESIGN-Full-Workflow-Integration-end-to-end-` | +10 | ❌ pre-policy | 0 | `22569bca` | oldest unmerged 2026-08-08 |
| `customers` | +11 | ❌ pre-policy | 0 | `c367a958` | oldest unmerged 2026-08-08 |
| `claude-code-homelab` | +10 | ❌ pre-policy | 0 | `dfe5716b` | oldest unmerged 2026-08-08 |
| `Chronikomicon` | +10 | ❌ pre-policy | 0 | `23422fdc` | oldest unmerged 2026-08-08 |
| `Azure-lab` | +10 | ❌ pre-policy | 0 | `2762fb10` | oldest unmerged 2026-08-08 |

PR snapshot: **3 open PRs**, captured 2026-08-11T14:40:00Z (6.6h old) via GitHub MCP search_pull_requests `is:open user:a777ance` (org-wide, single query).
