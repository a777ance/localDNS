...
*   **🧭 [Provenance — governing epistemic inheritance](https://a777ance.github.io/localDNS/provenance.html)**: How a claim earns authority here — the M/O/D/R/A ladder, the rule that transmission never promotes (copying, publishing, and *agreeing* all preserve or lower a tier; only contact with the origin raises it), the four gates that check a tier before anything irreversible, and the failure catalogue. Enforced, not just documented: `tools/check-provenance.py`.
