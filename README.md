...
*   **🗺️ [A777ance Field Atlas — the interactive keep map](https://a777ance.github.io/localDNS/atlas.html)**: A draggable, force-directed network graph of the whole keep — 55 nodes across 9 glyph-coded realms, with a detail panel, search, minimap and cross-links. **Arrange** re-sorts the entire field (Orbit / Realms / Lineage / Kinship / Index); click a realm to focus-zoom, click its title to snap back. Assembled from this repo's docs + CLAUDE.md.
